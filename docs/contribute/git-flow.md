...
<!-- Title: Contributing GitFlow TerraformAwsIamS3User -->
...
To contribute to terraform-aws-iam-s3-user project on [GitHub](https://github.com/hadenlabs/terraform-aws-iam-s3-user), We use Gitflow (See more [here](https://datasift.github.io/gitflow/IntroducingGitFlow.html)) In a nutshell, it means that you should branch from the main repository and contribute back by making [pull request](https://github.com/hadenlabs/terraform-aws-iam-s3-user/pulls).

![workflow gitflow](https://datasift.github.io/gitflow/GitFlowHotfixBranch.png)

## Getting started

To follow the instructions in this guide and start contributing to terraform-aws-iam-s3-user project on Github:
...
```bash
git remote add upstream  https://github.com/hadenlabs/terraform-aws-iam-s3-user.git
```

Now your **upstream** points to **hadenlabs/terraform-aws-iam-s3-user**.
...
git fetch upstream # assuming upstream is hadenlabs/terraform-aws-iam-s3-user
...
All merge requests are automatically tested using [Github Actions](https://github.com/hadenlabs/terraform-aws-iam-s3-user/actions). In case some tests fail, fix the issues or describe why the fix cannot be done.
